export default function CommunityPostDetail() {
  return (
    <div>
      <span className="my-2.5 ml-4 inline-flex items-center rounded-full bg-gray-100 px-2.5 py-0.5 text-xs font-semibold text-gray-800">
        동네질문
      </span>
      <div className="mb-3 flex cursor-pointer items-center space-x-3 border-b px-4 py-3">
        <div className="h-10 w-10 rounded-full bg-slate-300" />
        <div>
          <p className="text-sm font-semibold text-gray-700">Steve Jobs</p>
      ...
      <div>
        <div className="mt-2 px-4 text-gray-700">
          <span className="font-semibold text-orange-500">Q.</span> What is the
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="mt-2 text-gray-700">
              The best mandu restaurant is the one next to GS.
            </p>
          </div>
        </div>
      </div>
