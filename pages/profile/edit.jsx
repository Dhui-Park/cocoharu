    ...
    <div className="space-y-4 py-10 px-4">
      <div>
        <div className="flex items-center space-x-3">
          ...
          <label
            htmlFor="picture"
            className="cursor-pointer rounded-md border border-gray-300 py-2 px-3 text-sm font-semibold text-gray-700 shadow-sm focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
          >
            Change Photo
            <input
              id="picture"
