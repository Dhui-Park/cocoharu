      ...
      <div className="mt-16">
        ...
        <div className="mt-8">
          ...
          <div className="mt-2 grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-500 shadow-sm hover:bg-gray-200">
              <svg
                className="h-5 w-5"
                aria-hidden="true"
                fill="currentColor"
